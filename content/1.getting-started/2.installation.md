...
Поддерживаются версии `v18.15.0` или `v20` и выше.
::
...
Существует два способа развернуть OSMI с помощью Docker. :br Сначала клонируйте репозиторий: [OSMI](https://github.com/myosminozhka-ru/StartAI/tree/translation) используя git clone
