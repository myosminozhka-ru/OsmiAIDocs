...
API предсказаний это основной интерфейс для взаимодействия с вашими потоками и помощниками в ЩыьOSMI. Он позволяет отправлять сообщения выбранному потоку и получать ответы. Этот API обеспечивает основную функциональность чата, включая:
...
Подробности смотрите в разделе API справочник по [Prediction Endpoint](api-reference/prediction).

## Базовый URL и аутентификация

**Base URL:** <http://localhost:3000> (или URL вашей инстанции OSMI AI)
**Endpoint:** POST /api/v1/prediction/\:id
**Аутентификация:** см. раздел [Authentication for OSMI AI](/configuration/auth/chatflow-level)
...
OSMI предоставляет официальные SDK для Python и TypeScript/JavaScript:
...
```python
from OSMI import OSMI, PredictionData

# Initialize client
client = OSMI(base_url="http://localhost:3000")
...
```typescript
import { OSMIClient } from 'OSMI-sdk';

// Initialize client
const client = new OSMIClient({ 
...
![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FZCZdo81kaLaOiyTzb460%2Fimage.png?alt=media\&token=7329f1bf-996b-4e53-8542-8a3a99aa65e6){width="418"}
...
::div{align="right" dataFullWidth="false"}
![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FGy8YAOzLmMJdCLXlXtap%2Fimage.png?alt=media\&token=d3b2169e-2c3b-42b1-82e6-6609a1008bbf)
::
...
![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FchZeQHXse3xJocJqTxyy%2Fimage.png?alt=media\&token=cff4fc5f-3c62-45f9-b844-0a9e7c02f96e)
...
![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FCGKjSN8i5ScLaQo3b8Yy%2Fimage.png?alt=media\&token=7e55bd65-57a9-4cb1-a328-6d7b40b5f1df)

В разделе «Execution» (Выполнение) можно увидеть переопределённое системное сообщение.

![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2F53dACHPjS8woinXUdKtr%2Fimage.png?alt=media\&token=5ac21787-805f-490c-a69f-aab117181b60)
...
![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FluT55FTMLVdOc5KNVIvv%2Fimage.png?alt=media\&token=1e81eff7-d752-40cf-96e3-81e7da8e11e6)![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FlD9UrmokPqFzxr48xhhA%2Fimage.png?alt=media\&token=973a5740-c5b9-48db-b624-cba10863f602)
...
![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FieXA3ALePeoMHEuugoty%2Fimage.png?alt=media\&token=df5957a0-9110-4a59-9e70-ee101d600fe5)![](https://823733684-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F00tYLwhz5RyR7fJEhrWy%2Fuploads%2FxEFCcxc81zfoNUwK5s45%2Fimage.png?alt=media\&token=b35dbd94-9ecb-416c-b348-253226139d34)
...
⚠️ Переменные должны быть заранее созданы в разделе **Variables**.
...
Подробнее см. раздел [Изображения](/using-flowise/uploads).
...
Загрузите файлы для обработки LLM, чтобы получить ответы на связанные запросы. Дополнительную информацию можно найти в разделе [Файлы](/using-flowise/uploads#files).
