...
**Base URL:** <http://localhost:3000> (или URL вашей инстанции OSMI AI) :br **Endpoint:** POST /api/v1/prediction/\:id :br **Аутентификация:** см. раздел [Authentication for OSMI AI](https://docs.myosmi-ai.fvds.ru/configuration/auth/chatflow-level)
