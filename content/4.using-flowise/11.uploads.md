...
В агенте должен быть добавлен векторный хранилище, поддерживающее загрузку файлов. Поддерживаемые системы:
...
Если в агенте используется несколько векторных хранилищ, загрузка файла возможна только для одного из них одновременно.Необходимо подключить хотя бы один узел загрузчика документов к входу документов этого векторного хранилища.
