---
title: Базы данных
description: Узнайте, как подключить ваш экземпляр  osmi_ai к базе данных.
---

### Настройка:

Настройка osmi\_ai поддерживает 4 типа баз данных:
...
Файл `database.sqlite` будет создан и сохранён по указанному пути в переменной `DATABASE_PATH`. Если переменная не указана, файл будет сохранён по умолчанию в вашей домашней директории — . osmi\_ai.
...
### **Как использовать базы данных osmi\_ai SQLite и MySQL/MariaDB**

:video{src="https://youtu.be/R-6uV1Cb8I8"}

## **Резервное копирование (**&#x42;ackup)

1. Завершите работу приложения osmi\_aiAI.
...
2. **Создание резервной копии базы данных:**&#x57;indows:
   ...
   ```
3. Проверьте работу резервной копии, запустив osmi\_ai.
...
3. Создание тестовой базы данных:
   ...
   ```
4. Проверьте работоспособность резервной копии, запустив osmi\_ai, предварительно поправив файл `.env`, чтобы он указывал на тестовую базу данных.
...
3. Создание тестовой базы данных:
   ...
   ```
4. Проверьте работоспособность резервной копии, запустив osmi\_ai с обновлённым файлом `.env`, чтобы он указывал на резервную базу данных.
