---
  title: Интеграции
  description: Узнайте обо всех доступных интеграциях (узлах) в Платформа.
---


В Платформа узлы называются интеграциями. Как из LEGO, вы можете собрать собственный Флоу оркестрации БЯМ: чат-бот, агент и т. п., используя имеющиеся интеграции.
