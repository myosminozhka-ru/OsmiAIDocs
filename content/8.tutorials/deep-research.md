...
- Research SubAgents (подагенты исследования): Отдельные агенты, выполняющие целенаправленное исследование с помощью поиска в Интернете и других интеграций.
...
- Пример подсказки - research\_subagent.md
...
3. Добавьте следующие интеграции для исследования, вы можете использовать свои предпочитаемые интеграци:
   ...
   - **Web Scraper**: для извлечения содержимого веб-страниц. Эта интеграция будет собирать содержимое по ссылкам из Google Search
