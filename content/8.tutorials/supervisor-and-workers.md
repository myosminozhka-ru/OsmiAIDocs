...
- следующий: {{ output.next }}
- инструкция: {{ output.instruction }}
...
- Условие 1: {{ $flow.state.instruction }} эквивалентно «РЕЦЕНЗЕНТ»
...
4. Установите значение «Входное сообщение»: `{{ $flow.state.инструкция }}`. Входное сообщение будет вставлено в конец, как будто пользователь даёт инструкцию агенту-программисту.
...
3. Установите значение «Входное сообщение»: `{{ $flow.state.инструкция }}`. Входное сообщение будет вставлено в конец, как будто пользователь даёт инструкцию агенту проверки кода.
