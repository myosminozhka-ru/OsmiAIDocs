...
description: В предыдущем уроке по взаимодействию с API мы рассмотрели, как
  заставить большую языковую модель (LLM) вызывать внешние API. Чтобы улучшить
  пользовательский опыт, OSMI-AI предоставляет список готовых инструментов.
  Полный список доступных интеграций можно найти в разделе
